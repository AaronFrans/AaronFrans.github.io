import{f as m,_ as g,j as _,w as b,T as y,o as i,c as n,a,t as v,n as h,h as k,p as j,e as I,r as u,F as P,g as C,d as f,k as A}from"./index-fe15ef5e.js";const D=m({name:"ProjectDetailsOverlay",props:{visible:Boolean,color:String,title:String,htmlContent:String},methods:{getImage:function(e){console.log("fetching image "+e)}}});const w=e=>(j("data-v-311e7fce"),e=e(),I(),e),T={key:0},S=w(()=>a("div",{class:"overlay"},null,-1)),$={class:"dialog-title"},N=w(()=>a("i",{class:"fa fa-times fa-lg fa-fw"},null,-1)),M=[N],G={class:"dialog-content"},L=["innerHTML"],O={class:"dialog-bottom"};function B(e,o,l,c,d,p){return i(),_(y,{name:"fade"},{default:b(()=>[e.visible?(i(),n("div",T,[S,a("div",{class:"dialog",style:h({"background-color":e.color})},[a("h1",$,v(e.title),1),a("div",{onClick:o[0]||(o[0]=s=>e.$emit("close")),class:"dialog-close"},M),a("div",G,[a("div",{innerHTML:e.htmlContent},null,8,L),a("div",O,[a("a",{onClick:o[1]||(o[1]=s=>e.$emit("close")),class:"dialog-close-button"},"Close")])])],4)])):k("",!0)]),_:1})}const F=g(D,[["render",B],["__scopeId","data-v-311e7fce"]]),H=m({name:"ProjectsList",components:{ProjectDetailsOverlay:F},props:{projects:Array},data:function(){return{showPopup:!1,popupTitle:"",popupColor:"",popupContent:""}},methods:{showDetails:function(e){this.popupTitle=e.name,this.popupColor=e.accentColor,this.popupContent=e.htmlDescription,this.showPopup=!0,window.scrollTo(0,0)}}});const x={class:"projects-list"},W=["onClick"],U={class:"title-text"};function Z(e,o,l,c,d,p){const s=u("ProjectDetailsOverlay");return i(),n("div",null,[a("div",x,[(i(!0),n(P,null,C(e.projects,t=>(i(),n("div",{key:t.id,onClick:q=>e.showDetails(t),class:A(["project-item",{wide:t.isWide,high:t.isHigh}])},[a("div",{class:"project-item-image",style:h({"background-image":"url("+t.iconUrl+")"})},null,4),a("div",{class:"title-bar",style:h({"background-color":t.accentColor+"DD"})},[a("div",U,v(t.name),1)],4)],10,W))),128))]),f(s,{onClose:o[0]||(o[0]=t=>e.showPopup=!1),visible:e.showPopup,title:e.popupTitle,htmlContent:e.popupContent,color:e.popupColor},null,8,["visible","title","htmlContent","color"])])}const R=g(H,[["render",Z],["__scopeId","data-v-f6bd82fd"]]);class r{constructor(o,l,c,d,p="#000000",s=!1,t=!1){this.id=o,this.name=l,this.htmlDescription=d,this.iconUrl=c,this.isHigh=s,this.isWide=t,this.accentColor=p}}const V=[new r("Overseer","Underworld Overseer","img/projects/Overseer.jpg",`
    <div class="paragraph">
    ...
    `,"#23bd69"),new r("API Pokédex","Pokédex with API","img/projects/Pokedex_API_Video.gif",`
    <div class="paragraph center">
    ...
    </div>`,"#797d7a"),new r("Mario Overlord","Mario64 Remake","img/projects/Mario_Trailer.gif",`
    <div class="paragraph center">
        <div class="notice error">
    ...
    </div>`,"#e48246")],z=m({name:"GameProjects",components:{ProjectsList:R},data:function(){return{projects:V}}}),E=a("h1",null,"Projects I have worked on",-1),J=a("div",{style:{"margin-bottom":"30px"}}," These are some of the projects I have made or have contributed to. ",-1);function X(e,o,l,c,d,p){const s=u("ProjectsList");return i(),n("div",null,[E,J,f(s,{projects:e.projects},null,8,["projects"])])}const Q=g(z,[["render",X]]);export{Q as default};
