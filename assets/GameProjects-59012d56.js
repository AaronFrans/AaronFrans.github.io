import{f as m,_ as g,j as _,w as b,T as k,o as r,c as n,a as t,t as u,n as h,h as j,p as y,e as C,r as f,F as I,g as D,d as v,k as S}from"./index-f7405f37.js";const $=m({name:"ProjectDetailsOverlay",props:{visible:Boolean,color:String,title:String,htmlContent:String},methods:{getImage:function(e){console.log("fetching image "+e)}}});const w=e=>(y("data-v-311e7fce"),e=e(),C(),e),P={key:0},A=w(()=>t("div",{class:"overlay"},null,-1)),N={class:"dialog-title"},L=w(()=>t("i",{class:"fa fa-times fa-lg fa-fw"},null,-1)),O=[L],T={class:"dialog-content"},W=["innerHTML"],G={class:"dialog-bottom"};function M(e,o,l,c,d,p){return r(),_(k,{name:"fade"},{default:b(()=>[e.visible?(r(),n("div",P,[A,t("div",{class:"dialog",style:h({"background-color":e.color})},[t("h1",N,u(e.title),1),t("div",{onClick:o[0]||(o[0]=s=>e.$emit("close")),class:"dialog-close"},O),t("div",T,[t("div",{innerHTML:e.htmlContent},null,8,W),t("div",G,[t("a",{onClick:o[1]||(o[1]=s=>e.$emit("close")),class:"dialog-close-button"},"Close")])])],4)])):j("",!0)]),_:1})}const B=g($,[["render",M],["__scopeId","data-v-311e7fce"]]),H=m({name:"ProjectsList",components:{ProjectDetailsOverlay:B},props:{projects:Array},data:function(){return{showPopup:!1,popupTitle:"",popupColor:"",popupContent:""}},methods:{showDetails:function(e){this.popupTitle=e.name,this.popupColor=e.accentColor,this.popupContent=e.htmlDescription,this.showPopup=!0,window.scrollTo(0,0)}}});const F={class:"projects-list"},E=["onClick"],x={class:"title-text"};function U(e,o,l,c,d,p){const s=f("ProjectDetailsOverlay");return r(),n("div",null,[t("div",F,[(r(!0),n(I,null,D(e.projects,a=>(r(),n("div",{key:a.id,onClick:R=>e.showDetails(a),class:S(["project-item",{wide:a.isWide,high:a.isHigh}])},[t("div",{class:"project-item-image",style:h({"background-image":"url("+a.iconUrl+")"})},null,4),t("div",{class:"title-bar",style:h({"background-color":a.accentColor+"DD"})},[t("div",x,u(a.name),1)],4)],10,E))),128))]),v(s,{onClose:o[0]||(o[0]=a=>e.showPopup=!1),visible:e.showPopup,title:e.popupTitle,htmlContent:e.popupContent,color:e.popupColor},null,8,["visible","title","htmlContent","color"])])}const V=g(H,[["render",U],["__scopeId","data-v-f6bd82fd"]]);class i{constructor(o,l,c,d,p="#000000",s=!1,a=!1){this.id=o,this.name=l,this.htmlDescription=d,this.iconUrl=c,this.isHigh=s,this.isWide=a,this.accentColor=p}}const z=[new i("Overseer","Underworld Overseer","img/projects/Overseer.jpg",`
    <div class="paragraph">
    ...
    <div class="paragraph center">
        ...
        <img class="pc-screenshot" src="https://fakeimg.pl/534x300/" alt="Cloud Drew Land Screenshot" />
        <img class="pc-screenshot" src="https://fakeimg.pl/534x300/" alt="Cloud Drew Land Screenshot" />
    </div>`,"#e48246")],J=m({name:"GameProjects",components:{ProjectsList:V},data:function(){return{projects:z}}}),q=t("h1",null,"Projects I have worked on",-1),K=t("div",{style:{"margin-bottom":"30px"}}," These are some of the projects I have made or have contributed to. ",-1);function Q(e,o,l,c,d,p){const s=f("ProjectsList");return r(),n("div",null,[q,K,v(s,{projects:e.projects},null,8,["projects"])])}const Y=g(J,[["render",Q]]);export{Y as default};
